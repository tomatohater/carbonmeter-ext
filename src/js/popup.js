var bg;
var carbonPerPage = 1.76;	// Average carbon per page view as of 24-Mar-2021
...
function renderPage() {
  ...
  chart.style.height = (parseInt(columnHeight))+'px';
	...
	if(avgDay) {
	  ...
	  fc.innerHTML = formatCarbonWeight(year)+" CO<sub>2</sub>e/year";

	  var flight = 50 * 1000;
	  if(year >= flight) {
	    var fe = document.getElementById('forecast-equivalent');
	    fe.innerHTML = "Whoa! That's equivalent to " + (year/flight).toFixed(0) + " flights between Paris and London. ✈️"
	  }
	}
}
